...
class AjanuwRoute<A extends Object> {
  ...
  /// 检查是否为动态路由
  static bool isDynamicRouting(String path) => _textIsDynamicRouteExp.hasMatch(path);
  ...
  /// ),
  /// ```
  final TransitionDurationBuilder<Object>? transitionDurationBuilder;
  ...
  AjanuwRoute({
    ...
    this.transitionDurationBuilder,
        ...
        // 必须要有能渲染的对象
        assert(builder != null || builder == null && children != null || redirectTo != null),
